...
| Cache-safe data freshness | 177,866 | 54,147 | 33,660 | 310,918 |
...
The cache-safe build adds the global freshness disclosure and browser verification transport without a hashing dependency. Its lazy data-loader chunk is 4,468 bytes raw / 1,910 bytes gzip; the measured cold Pulse closure is 104,686 bytes gzip, and the aggregate build retains 4,082 bytes of headroom under the unchanged ceiling.
