...
Python generator and transitive test lanes use Python 3.13. Local data work should use `python3.13` (or the repository's configured Python 3.13 executable) so generated bytes match CI.
