...
- `npm run test:assets` validates `assets/H2H.json`, `assets/SeasonSummary.json`, `assets/Rivalries.json`, optional `assets/CurrentSeason.json`, and generated `assets/DraftSpot.json`.
