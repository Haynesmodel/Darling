...
function JourneyView({ journey, model }: { journey: Journey | null; model: TransactionModel }) {
  ...
  return <div class="transaction-journey" id={`transaction-player-${journey.player_id}`} tabindex={-1}>
    ...
    {journey.player_id === '8676' && <button type="button" class="btn transaction-lore-rashid" data-lore-trigger="rashid-shaheed-story" data-lore-value={journey.player_id} data-lore-facts={loreFacts}>Reveal Rashid Shaheed lore</button>}
  </div>;
}
