...
League Lore:
- `assets/LeagueLore.json` stores validated narrative entries, collections, trigger metadata, and search terms. See [`docs/league-lore.md`](./docs/league-lore.md) for source precedence, year fields, accessibility, and disable/rollback guidance.
