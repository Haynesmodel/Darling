...
| Plan | Status | Notes |
| --- | --- | --- |
| [IMPLEMENTATION_PLAN.md](./IMPLEMENTATION_PLAN.md) | complete | History-page architecture cleanup |
| [RIVALRY_IMPLEMENTATION_PLAN.md](./RIVALRY_IMPLEMENTATION_PLAN.md) | complete | Head to Head page implementation |
| [CURRENT_SEASON_IMPLEMENTATION_PLAN.md](./CURRENT_SEASON_IMPLEMENTATION_PLAN.md) | complete | Current season dashboard and Head to Head split |
