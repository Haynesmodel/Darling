...
Top level: a versioned object containing a shared `players` catalog and sorted `seasons`. The initial 2025 season contains 489 raw transactions, 417 complete transactions, 72 failed transactions, 8 completed trades, and one selected 192-pick draft.
