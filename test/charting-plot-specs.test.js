...
import { Plot, d3 } from '../js/charting/vendor/charting-vendor.js';
import {
...
test('local chart vendor bundle exposes Plot and D3 APIs', () => {
  assert.equal(typeof Plot.plot, 'function');
  assert.equal(typeof d3.scaleLinear, 'function');
});
